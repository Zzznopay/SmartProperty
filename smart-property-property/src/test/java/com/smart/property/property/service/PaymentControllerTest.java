...
class PaymentControllerTest {
    ...
    void testCollectPayment() {
        Room room = createRoom("PM11");
        Owner owner = createOwner("PM11-O");
        FeeItem feeItem = createFeeItem(room.getCommunityId(), "PM11-F");
    ...
    void testGetPaymentPage() {
        Room room = createRoom("PM12");
        Owner owner = createOwner("PM12-O");
    ...
    void testRefundPayment() {
        Room room = createRoom("PM13");
        Owner owner = createOwner("PM13-O");
    ...
    void testVoidPayment() {
        Room room = createRoom("PM14");
        Owner owner = createOwner("PM14-O");
        collectWithoutDetails(room, owner, "1000");
        Long id = getFirstByRoom(room.getId(), owner.getId()).getId();
