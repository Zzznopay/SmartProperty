...
@SpringBootTest
@Transactional
class DecorationRecordServiceTest {
    ...
    void testCreateDecoration() {
        Room room = createRoom("DR01");
        Owner owner = createOwner("DR01-O");
        ...
        assertEquals(1, created.getDepositStatus());
        assertNotNull(created.getApplyDate());
    }

    @Test
    void testGetDecorationPage() {
        Room room = createRoom("DR02");
        Owner owner = createOwner("DR02-O");
    ...
    void testStartDecoration() {
        Room room = createRoom("DR03");
        Owner owner = createOwner("DR03-O");
    ...
    void testCompleteDecoration() {
        Room room = createRoom("DR04");
        Owner owner = createOwner("DR04-O");
    ...
    void testCheckDecoration() {
        Room room = createRoom("DR05");
        Owner owner = createOwner("DR05-O");
        ...
        assertEquals(1, checked.getCheckResult());
    }
