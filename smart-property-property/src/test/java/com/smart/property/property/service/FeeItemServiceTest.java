...
class FeeItemServiceTest {
    ...
    @Test
    void testCreateFeeItem() {
        Community community = createCommunity("FSV-T1-C01");

        FeeItemVO created = createFeeItem(community.getId(), "物业费", "FSV-T1-F01");
    ...
    void testGetFeeItemPage() {
        Community community = createCommunity("FSV-T1-C02");
        createFeeItem(community.getId(), "物业费", "FSV-T1-F02");
    ...
    void testGetFeeItemsByCommunityId() {
        Community community = createCommunity("FSV-T1-C03");
        createFeeItem(community.getId(), "测试费项", "FSV-T1-F03");
