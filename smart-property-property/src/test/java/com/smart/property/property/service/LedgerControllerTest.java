...
class LedgerControllerTest {
    ...
    @Test
    void testAddLedger() {
        Room room = createRoom("LG11");
        Owner owner = createOwner("LG11-O");
        FeeItem feeItem = createFeeItem(room.getCommunityId(), "LG11-F");
    ...
    void testGetLedgerPage() {
        Room room = createRoom("LG12");
        Owner owner = createOwner("LG12-O");
        FeeItem feeItem = createFeeItem(room.getCommunityId(), "LG12-F");
    ...
    void testGetLedgersByRoomId() {
        Room room = createRoom("LG13");
        Owner owner = createOwner("LG13-O");
        FeeItem feeItem = createFeeItem(room.getCommunityId(), "LG13-F");
    ...
    void testGetArrearsPage() {
        Room room = createRoom("LG14");
        Owner owner = createOwner("LG14-O");
        FeeItem feeItem = createFeeItem(room.getCommunityId(), "LG14-F");
