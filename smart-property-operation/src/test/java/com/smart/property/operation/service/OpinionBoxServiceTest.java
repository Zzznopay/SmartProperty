...
class OpinionBoxServiceTest {
    ...
    @Test
    void testSaveOpinionBox() {
        OpinionBoxVO created = createBox("BOX-T1-01");
    ...
    void testSubmitOpinion() {
        OpinionBoxVO box = createBox("BOX-T1-03");

        OpinionSubmitVO submit = submitOpinion(box.getId(), "OP-T1-03-01");
    ...
    void testReplyOpinion() {
        OpinionBoxVO box = createBox("BOX-T1-04");

        OpinionSubmitVO submit = submitOpinion(box.getId(), "OP-T1-04-01");
    ...
    void testEvaluateOpinion() {
        OpinionBoxVO box = createBox("BOX-T1-05");

        OpinionSubmitVO submit = submitOpinion(box.getId(), "OP-T1-05-01");
