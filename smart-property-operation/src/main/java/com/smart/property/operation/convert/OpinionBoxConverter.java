...
public interface OpinionBoxConverter {

    @Mapping(target = "communityName", ignore = true)
    OpinionBoxVO toVO(OpinionBox entity);

    List<OpinionBoxVO> toVOList(List<OpinionBox> entities);
    ...
    OpinionBox toEntity(OpinionBoxDTO dto);
}