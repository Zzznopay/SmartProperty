...
/**
 * CleanArrange Entity ↔ DTO/VO 转换器。
 *
 * @author zzz
 * @since 2026-07-29
 */
...
public interface CleanArrangeConverter {

    CleanArrangeVO toVO(CleanArrange entity);

    List<CleanArrangeVO> toVOList(List<CleanArrange> entities);
    ...
    CleanArrange toEntity(CleanArrangeDTO dto);
}
